...
Partial Class RecibeUploadAndroid
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        For i = 0 To uploadFiles.Count - 1
            ...
            postedFile.SaveAs(System.Configuration.ConfigurationManager.AppSettings("RUTA_IMAGEN") & postedFile.FileName)
            'postedFile.SaveAs("\\192.0.0.3\archivos\" & postedFile.FileName)
