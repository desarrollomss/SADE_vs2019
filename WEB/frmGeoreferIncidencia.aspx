<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmGeoreferIncidencia.aspx.vb" Inherits="frmGeoreferIncidencia" %>
...
//        cityCircle = new google.maps.Circle(populationOptions);
        ...
        function loadPosition() {
            ...
            mgr = new MarkerManager(map);
            var webMethod = "WebServiceGPS.asmx/listarPosicionGPS";
            $.ajax({ type: "POST",
                url: webMethod,
                data: "{}",
                ...
                success: function (response) {
                    ...
                    $.each(lista, function (index, pan) {
                        var punto = new google.maps.LatLng(pan.nLat, pan.nLon);
                        var htmlVentana = pan.nISSI;
                        var label = "" + pan.nISSI + "";
                        //var img = "Mapa/tools/" + imagesM[parseInt(pan.PropUNITTYPE)];
                        var img = "Mapa/tools/01";
