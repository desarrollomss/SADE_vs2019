<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmIncidenciaMapa.aspx.vb" Inherits="frmIncidenciaMapa" %>
...
<body>
    ...
    <div id="pnlContenedor">
        <table class="Tabla" width="100%">
            ...
            <tr>
                <td></td>
                <td>
                    <table class="Tabla" width="900px" style="border: 1px solid #ccc;">
                        <colgroup>
                            <col width="5%" />
                            <col width="5%" />
                            <col width="5%" />
                    ...
                    <div id="divMap" style="width: 900px; height: 500px; border: 1px solid #ccc;">
                    </div>
                </td>
                <td></td>
            </tr>
    ...
    <script type="text/javascript">
        ...
        var vSERVER = "http://serviciosgis.munisurco.gob.pe/geoserver/CM150140/wms";
        var vFOTOS = "http://serviciosgis.munisurco.gob.pe/multimedia/fotos/catastro/2012/";
