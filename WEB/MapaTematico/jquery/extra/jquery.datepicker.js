...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		...
		clearStatus: 'Borrar el fecha actual', // Status text for clear link
		closeText: 'Cerrar', // Display text for close link
		closeStatus: 'Cerrar sin cambiar', // Status text for close link
		prevText: '&#x3c;&#x3c;', // Display text for previous month link
		prevStatus: 'Muestra el mes anterior', // Status text for previous month link
		nextText: '&#x3e;&#x3e;', // Display text for next month link
		nextStatus: 'Muestra el mes siguiente', // Status text for next month link
		currentText: 'Hoy', // Display text for current month link
		currentStatus: 'Muestra el mes actual', // Status text for current month link
		...
		monthStatus: 'Muestra un mes diferente', // Status text for selecting a month
		yearStatus: 'Muestra un año diferente', // Status text for selecting a year
		...
		dayStatus: 'Configura DD como primer dia de la semana', // Status text for the day of the week selection
		dateStatus: 'Selecciona DD, M d', // Status text for the date selection
		dateFormat: 'dd/mm/yy', // See format options on parseDate
		firstDay: 0, // The first day of the week, Sun = 0, Mon = 1, ...
		initStatus: 'Selecciona una fecha', // Initial Status text on opening
