...
if(jQuery) (function($){
	...
	$.extend($.fn, {
		multiSelect: function(o, callback) {
			...
			if( o.oneOrMoreSelected == undefined ) o.oneOrMoreSelected = '% seleccionado';
			
			// Initialize each multiSelect
			$(this).each( function() {
				var select = $(this);
				var html = '<input type="text" readonly="readonly" class="multiSelect" value="" style="cursor: default;" />';
				html += '<div id="div_' + $(select).attr('name') + '" class="multiSelectOptions" style="position: absolute; z-index: 99999; display: none;">';
