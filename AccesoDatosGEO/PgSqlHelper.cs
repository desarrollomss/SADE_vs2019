...
namespace AccesoDatosGEO
{
    ...
    public sealed class NpgsqlHelper
    {
        ...
        /// <summary>
        /// This method is used to attach array of NpgsqlParameters to a NpgNpgsqlCommand.
        /// 
        ...
        /// <param name="commandText">The stored procedure name or Npsql command</param>
        ...
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">The stored procedure name or Npgsql command</param>
        ...
        private static NpgsqlDataReader ExecuteReader(NpgsqlConnection connection, NpgsqlTransaction transaction, CommandType commandType, string commandText, NpgsqlParameter[] commandParameters, NpgsqlConnectionOwnership connectionOwnership)
        {
            ...
            try
            {
                ...
                // Detach the NpgsqlParameters from the command object, so they can be used again.
                // ACK: There is a problem here, the output parameter values are fletched 
        ...
        /// </remarks>
        /// <param name="insertCommand">A valid transacNpgsql statement or stored procedure to insert new records into the data source</param>
        /// <param name="deleteCommand">A valid transacNpgsql statement or stored procedure to delete records from the data source</param>
        /// <param name="updateCommand">A valid transacNpgsql statement or stored procedure used to update records in the data source</param>
