...
#End Region
        ...
        Sub New(ByVal nombreDeConexion As String, ByVal nombreDeEsquema As String, ByVal nombreDeTabla As String)
            ...
            _Conexion = New DB2Connection(cadenaDeConexion)
        End Sub
...
#End Region
        ...
        Protected Function EjecutarEscalar(ByVal comando As DB2Command) As Object
            comando.Connection = Conexion
            comando.Connection.Open()
        ...
        'Protected Function CrearComando(ByVal nombreDeProcedimiento As String, ByVal entidad As TipoEntidad) As DbCommand
        '    Dim comando As DbCommand = New DB2Command
        '    comando.CommandText = nombreDeProcedimiento
        '    comando.CommandType = CommandType.StoredProcedure
        '    For Each propiedad As DictionaryEntry In entidad.ObtenerEnIDictionary
        '        Dim dbParameter As DbParameter = New DB2Parameter
